!(function (a) {
    ...
    var c = function (b, c) {
        var f = this;
        (this.element = a(b)),
            (this.autoShow = void 0 == c.autoShow || c.autoShow),
            (this.appendTo = c.appendTo || "body"),
            (this.closeButton = c.closeButton),
            (this.language =
                c.language || this.element.data("date-language") || "en"),
            (this.language =
                this.language in d
                    ? this.language
            ...
            this.component &&
                ...
                (this.component = !1),
            (this.linkField =
                c.linkField || this.element.data("link-field") || !1),
            (this.linkFormat = e.parseFormat(
                c.linkFormat ||
                    this.element.data("link-format") ||
                    "yyyy-mm-dd hh:ii:ss",
            )),
            (this.minuteStep =
                c.minuteStep || this.element.data("minute-step") || 5),
            (this.pickerPosition =
                c.pickerPosition ||
                this.element.data("picker-position") ||
                "bottom-right"),
            (this.initialDate = c.initialDate || null),
            (this.faCSSprefix = c.faCSSprefix || "fa"),
            (this.leftArrow =
                c.leftArrow ||
                '<i class="' +
                    this.faCSSprefix +
            ...
            "minView" in c ||
                ...
                1 == this.pickTime
                    ? ((this.minView = 0), (this.maxView = 4))
                    : ((this.minView = 2), (this.maxView = 4))),
            (this.forceParse = !0),
            "forceParse" in c
                ? (this.forceParse = c.forceParse)
                : "dateForceParse" in this.element.data() &&
                  (this.forceParse = this.element.data("date-force-parse")),
            (this.picker = a(
                e.template(this.leftArrow, this.rightArrow, this.closeIcon),
            )
            ...
            this.isRTL &&
                ...
                this.picker.find(".date-switch").each(function () {
                    a(this).parent().prepend(a(this).siblings(".next")),
                        a(this).parent().append(a(this).siblings(".prev"));
                }),
                this.picker.find(".prev, .next").toggleClass("prev next")),
            a(document).on("mousedown", function (b) {
                (f.isInput && b.target === f.element[0]) ||
                    (0 ===
                        a(b.target).closest(
            ...
            "calendarWeeks" in c
                ? (this.calendarWeeks = c.calendarWeeks)
                : "dateCalendarWeeks" in this.element.data() &&
                  (this.calendarWeeks = this.element.data(
                      "date-calendar-weeks",
                  )),
            this.calendarWeeks &&
                this.picker
            ...
            (this.datesDisabled = []),
            this.setStartDate(
                c.startDate || this.element.data("date-startdate"),
            ),
            ...
            this.setDatesDisabled(
                c.datesDisabled || this.element.data("dates-disabled"),
            ),
            null != this.initialDate &&
                ((this.date = this.viewDate =
                    e.parseDate(this.initialDate, this.format, this.language)),
                this.setValue()),
            this.fillDow(),
            this.fillMonths(),
            this.update(),
    ...
    (c.prototype = {
        ...
        setDaysOfWeekDisabled: function (b) {
            (this.daysOfWeekDisabled = b || []),
                a.isArray(this.daysOfWeekDisabled) ||
                    (this.daysOfWeekDisabled =
                        this.daysOfWeekDisabled.split(/,\s*/)),
                (this.daysOfWeekDisabled = a.map(
                    this.daysOfWeekDisabled,
                    function (a) {
        ...
        setDatesDisabled: function (b) {
            (this.datesDisabled = b || []),
                a.isArray(this.datesDisabled) ||
        ...
        place: function () {
            if (!this.isInline) {
                ...
                this.element.parents().map(function () {
                    "auto" != a(this).css("z-index") &&
                        b.push(parseInt(a(this).css("z-index")));
                });
                var c =
                        b
                            .sort(function (a, b) {
                ...
                var j =
                        a(window).scrollTop() <
                        e.top - this.picker.outerHeight(),
                    k =
                        h + this.picker.outerHeight() <
                        a(window).scrollTop() + a(window).height();
                !k && j
                    ? ((h = e.top - this.picker.outerHeight()),
                      this.picker.addClass("datepicker-top"))
                    : (k || a(window).scrollTop(e.top),
                      this.picker.addClass("datepicker-bottom")),
                    e.left + this.picker.width() >= a(window).width() &&
                        (i = e.left + g - this.picker.width()),
                    this.picker.css({ top: h, left: i, zIndex: c });
            }
        },
        update: function () {
            var a,
            ...
            ("string" == typeof arguments[0] || arguments[0] instanceof Date)
                ...
                b
                    ? this.setValue()
                    : "" == c &&
                      this.element.trigger({ type: "changeDate", date: null }),
        ...
        fill: function () {
            if (null != this.date && null != this.viewDate) {
                ...
                this.picker
                    ...
                    .text(d[this.language].months[g] + " " + f),
                    this.picker
                        .find(".datepicker-hours thead th:eq(1)")
                        .text(h + " " + d[this.language].months[g] + " " + f),
                    this.picker
                ...
                for (var t, u = []; q.valueOf() < s; ) {
                    ...
                    (t = " " + this.onRender(q) + " "),
                        q.getUTCFullYear() < f ||
                        (q.getUTCFullYear() == f && q.getUTCMonth() < g)
                            ? (t += " old")
                            : (q.getUTCFullYear() > f ||
                                  (q.getUTCFullYear() == f &&
                                      q.getUTCMonth() > g)) &&
                              (t += " new"),
                        this.todayHighlight &&
                            q.getUTCFullYear() == p.getFullYear() &&
                            q.getUTCMonth() == p.getMonth() &&
                            q.getUTCDate() == p.getDate() &&
                            (t += " today"),
                        o && q.valueOf() == o && (t += " active"),
                        (q.valueOf() < this.startDate ||
                            q.valueOf() > this.endDate ||
                            -1 !==
                                a.inArray(
                                    q.getUTCDay(),
                                    this.daysOfWeekDisabled,
                            ...
                            -1 !==
                                a.inArray(q.valueOf(), this.datesDisabled)) &&
                            (t += " disabled"),
                        u.push(
                            '<td class="day' +
                                t +
                ...
                for (var y = 0; y < 24; y++) {
                    var z = b(f, g, h, y);
                    (t = ""),
                        z.valueOf() + 36e5 < this.startDate ||
                        z.valueOf() > this.endDate
                            ? (t += " disabled")
                            : i == y && (t += " active"),
                        u.push(
                            '<span class="hour' + t + '">' + y + ":00</span>",
                        );
                }
        ...
        updateNavArrows: function () {
            ...
            switch (this.viewMode) {
                case 0:
                    this.startDate !== -1 / 0 &&
                    b <= this.startDate.getUTCFullYear() &&
                    c <= this.startDate.getUTCMonth() &&
                    d <= this.startDate.getUTCDate() &&
                    e <= this.startDate.getUTCHours()
                        ? this.picker
                              .find(".prev")
                        ...
                        this.endDate !== 1 / 0 &&
                        b >= this.endDate.getUTCFullYear() &&
                        c >= this.endDate.getUTCMonth() &&
                        d >= this.endDate.getUTCDate() &&
                        e >= this.endDate.getUTCHours()
                            ? this.picker
                                  .find(".next")
                                  .css({ visibility: "hidden" })
                            : this.picker
        ...
        click: function (c) {
            c.stopPropagation(),
                c.preventDefault(),
                (a(c.target).hasClass("datepicker-close") ||
                    a(c.target).parent().hasClass("datepicker-close")) &&
                    this.hide();
        ...
        showMode: function (a) {
            if (a) {
                var b = Math.max(
                    0,
                    Math.min(e.modes.length - 1, this.viewMode + a),
                );
            ...
            this.picker
                .find(">div")
                .hide()
                .filter(".datepicker-" + e.modes[this.viewMode].clsName)
                .css("display", "block"),
                this.updateNavArrows();
        },
                ...
                this.each(function () {
                    ...
                    f ||
                        e.data(
                            ...
                            (f = new c(
                                this,
                                a.extend({}, a.fn.fdatepicker.defaults, g),
                            )),
                        ),
                        "string" == typeof b &&
                            "function" == typeof f[b] &&
    ...
    var d = (a.fn.fdatepicker.dates = {
        ...
        e = {
            ...
            parseDate: function (c, e, f) {
                ...
                if (
                    (/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(c) &&
                        (e = this.parseFormat("yyyy-mm-dd")),
                    /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(c) &&
                        (e = this.parseFormat("yyyy-mm-dd hh:ii")),
                    /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(
                        c,
                    ) && (e = this.parseFormat("yyyy-mm-dd hh:ii:ss")),
                    ...
                    for (var k = 0; k < j.length; k++)
                        switch (
                            ((g = i.exec(j[k])), (h = parseInt(g[1])), g[2])
                        ) {
                            case "d":
                                c.setUTCDate(c.getUTCDate() + h);
                                break;
                            case "m":
                                c = Datetimepicker.prototype.moveMonth.call(
                            ...
                            case "w":
                                ...
                                break;
                            case "y":
                                c = Datetimepicker.prototype.moveYear.call(
                                    Datetimepicker.prototype,
                                    c,
                                    h,
                                );
                            ...
                            switch (g) {
                                ...
                                case "M":
                                    (m = a(d[f].monthsShort).filter(
                                        ...
                                        (l =
                                            a.inArray(m[0], d[f].monthsShort) +
                                            1);
                            }
                        n[g] = l;
                    }
                    for (var r, k = 0; k < o.length; k++)
                        (r = o[k]) in n && !isNaN(n[r]) && p[r](c, n[r]);
                }
                return c;
            },
            ...
            headTemplate: function (a, b) {
                return (
                    '<thead><tr><th class="prev">' +
                    a +
                    '</th><th colspan="5" class="date-switch"></th><th class="next">' +
                    b +
                    "</th></tr></thead>"
                );
            },
